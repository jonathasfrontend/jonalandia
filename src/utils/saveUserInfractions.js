...
async function saveUserInfractions(
    ...
    try {
        ...
        info.info(`Infração registrada no banco com sucesso no usuário ${username} ${reason}.`);

    } catch (error) {
        erro.error('Erro ao aplicar ao cadastrar a infração no banco de dados:', error);
